import { Eye, Edit, Calendar, User, Phone, Home, Zap, Droplet, Trash, WashingMachine, Columns2, Car } from 'lucide-react';
                ...
                <div className="p-6 space-y-6">
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                            ...
                            <div className="flex items-center gap-2 mb-3">
                                <Zap className="w-5 h-5 text-yellow-600" />
                                <h4 className="text-yellow-900">Điện (cũ - mới): {payment.electStart} - {payment.electEnd}</h4>
                            </div>
                            <div className="space-y-2 text-sm">
                                ...
                                <div className="flex justify-between text-base">
                                    <span className="text-yellow-900">Thành tiền: {electUsage} số × {formatCurrency(payment.electPrice)}</span>
                        ...
                        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                            ...
                            <div className="flex items-center gap-2 mb-3">
                                <Droplet className="w-5 h-5 text-blue-600" />
                                <h4 className="text-blue-900">Nước (cũ - mới): {payment.waterStart} - {payment.waterEnd}</h4>
                            </div>
                            <div className="space-y-2 text-sm">
                                {/* <div className="flex justify-between">
                                ...
                                <div className="flex justify-between text-base">
                                    <span className="text-blue-900">Thành tiền: {waterUsage} số × {formatCurrency(payment.waterPrice)}</span>
